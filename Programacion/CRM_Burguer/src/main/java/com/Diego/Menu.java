...
public class Menu {
    public static void Menuprincipal() {
        ...
        do {
            ...
            switch (option) {
                case 1:
                    customerCtrl.menuClientes();
                    break;
                case 2:
                    employeeCtrl.menuEmpleados();
                    break;
                case 3:
                    productCtrl.menuProductos();
                    break;
                case 4:
                    orderCtrl.menuPedidos();
                    break;
                case 5:
                    detailCtrl.menuDetalles();
                    break;
                case 6:
                    exportCustomersToCSV();
                    break;
                case 0:
                    System.out.println(" Saliendo del sistema CRM_Burguer...");
                    break;
                default:
